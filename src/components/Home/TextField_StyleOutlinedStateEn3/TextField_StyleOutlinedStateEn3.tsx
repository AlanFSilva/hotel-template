...
import classes from './TextField_StyleOutlinedStateEn3.module.css';
...
/* @figmaId 3:9464 */
export const TextField_StyleOutlinedStateEn3: FC<Props> = memo(function TextField_StyleOutlinedStateEn3(props = {}) {
  return (
